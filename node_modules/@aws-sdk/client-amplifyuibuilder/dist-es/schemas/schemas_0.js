...
export var CodegenFeatureFlags$ = [3, n0, _CFF,
    0,
    [_iRS, _iNMS],
    [2, 2]
];
export var CodegenGenericDataEnum$ = [3, n0, _CGDE,
    0,
    [_v],
    [64 | 0], 1
];
export var CodegenGenericDataField$ = [3, n0, _CGDF,
    0,
    [_dT, _dTV, _re, _rO, _iA, _rel],
    [0, 0, 2, 2, 2, () => CodegenGenericDataRelationshipType$], 5
];
export var CodegenGenericDataModel$ = [3, n0, _CGDM,
    0,
    [_f, _pK, _iJT],
    [() => CodegenGenericDataFields, 64 | 0, 2], 2
];
export var CodegenGenericDataNonModel$ = [3, n0, _CGDNM,
    0,
    [_f],
    [() => CodegenGenericDataNonModelFields], 1
];
export var CodegenGenericDataRelationshipType$ = [3, n0, _CGDRT,
    0,
...
export var ComponentVariant$ = [3, n0, _CV,
    0,
    [_vV, _o],
...
export var CreateFormRequest$ = [3, n0, _CFR,
    0,
    [_aI, _eN, _fTC, _cTl],
...
export var CreateThemeRequest$ = [3, n0, _CTR,
    0,
    [_aI, _eN, _tTC, _cTl],
...
export var DeleteFormRequest$ = [3, n0, _DFR,
    0,
    [_aI, _eN, _i],
    [[0, 1], [0, 1], [0, 1]], 3
];
export var DeleteThemeRequest$ = [3, n0, _DTR,
    0,
    [_aI, _eN, _i],
    [[0, 1], [0, 1], [0, 1]], 3
];
export var ExchangeCodeForTokenRequest$ = [3, n0, _ECFTR,
    0,
    [_prov, _req],
    [[0, 1], [() => ExchangeCodeForTokenRequestBody$, 16]], 2
];
export var ExchangeCodeForTokenRequestBody$ = [3, n0, _ECFTRB,
    0,
    [_cod, _rU, _cI],
    [[() => SensitiveString, 0], 0, [() => SensitiveString, 0]], 2
];
export var ExchangeCodeForTokenResponse$ = [3, n0, _ECFTRx,
    0,
    [_aT, _eI, _rT],
    [[() => SensitiveString, 0], 1, [() => SensitiveString, 0]], 3
];
export var ExportComponentsRequest$ = [3, n0, _ECR,
    0,
    [_aI, _eN, _nT],
    [[0, 1], [0, 1], [0, { [_hQ]: _nT }]], 2
];
...
export var FieldInputConfig$ = [3, n0, _FIC,
    0,
...
export var FieldValidationConfiguration$ = [3, n0, _FVC,
    0,
    [_t, _sVt, _nV, _vMa],
    [0, 64 | 0, 64 | 1, 0], 1
];
export var FileUploaderFieldConfig$ = [3, n0, _FUFC,
    0,
    [_aL, _aFT, _sT, _iR, _mFC, _mS],
    [0, 64 | 0, 2, 2, 1, 1], 2
];
export var Form$ = [3, n0, _F,
    0,
...
export var FormBindingElement$ = [3, n0, _FBE,
    0,
    [_ele, _pro],
    [0, 0], 2
];
...
export var FormDataTypeConfig$ = [3, n0, _FDTC,
    0,
    [_dST, _dTN],
    [0, 0], 2
];
export var FormInputBindingPropertiesValue$ = [3, n0, _FIBPV,
    0,
    [_t, _bP],
...
export var FormInputValuePropertyBindingProperties$ = [3, n0, _FIVPBP,
    0,
    [_pro, _fi],
    [0, 0], 1
];
export var FormStyle$ = [3, n0, _FS,
    0,
    [_hG, _vG, _oP],
    [() => FormStyleConfig$, () => FormStyleConfig$, () => FormStyleConfig$]
];
export var FormSummary$ = [3, n0, _FSo,
    0,
    [_aI, _dT, _eN, _fAT, _i, _n],
    [0, () => FormDataTypeConfig$, 0, 0, 0, 0], 6
];
export var GetCodegenJobRequest$ = [3, n0, _GCJR,
    0,
    [_aI, _eN, _i],
    [[0, 1], [0, 1], [0, 1]], 3
];
export var GetCodegenJobResponse$ = [3, n0, _GCJRe,
    0,
    [_j],
    [[() => CodegenJob$, 16]]
];
...
export var GetFormRequest$ = [3, n0, _GFR,
    0,
    [_aI, _eN, _i],
    [[0, 1], [0, 1], [0, 1]], 3
];
export var GetFormResponse$ = [3, n0, _GFRe,
    0,
    [_fo],
    [[() => Form$, 16]]
];
export var GetMetadataRequest$ = [3, n0, _GMR,
    0,
    [_aI, _eN],
    [[0, 1], [0, 1]], 2
];
export var GetMetadataResponse$ = [3, n0, _GMRe,
    0,
    [_fe],
    [128 | 0], 1
];
export var GetThemeRequest$ = [3, n0, _GTR,
    0,
    [_aI, _eN, _i],
    [[0, 1], [0, 1], [0, 1]], 3
];
export var GetThemeResponse$ = [3, n0, _GTRe,
    0,
    [_the],
    [[() => Theme$, 16]]
];
export var GraphQLRenderConfig$ = [3, n0, _GQLRC,
    0,
...
export var ListThemesRequest$ = [3, n0, _LTR,
    0,
    [_aI, _eN, _nT, _mR],
    [[0, 1], [0, 1], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]], 2
];
...
export var NoApiRenderConfig$ = [3, n0, _NARC,
    0,
    [],
    []
];
export var Predicate$ = [3, n0, _P,
    0,
    [_or, _an, _fi, _op, _ope, _oT],
    [() => PredicateList, () => PredicateList, 0, 0, 0, 0]
];
export var PutMetadataFlagBody$ = [3, n0, _PMFB,
    0,
    [_nVe],
    [0], 1
];
export var PutMetadataFlagRequest$ = [3, n0, _PMFR,
    0,
    [_aI, _eN, _fN, _bo],
...
export var RefreshTokenRequestBody$ = [3, n0, _RTRB,
    0,
    [_to, _cI],
    [[() => SensitiveString, 0], [() => SensitiveString, 0]], 1
];
export var RefreshTokenResponse$ = [3, n0, _RTRe,
    0,
    [_aT, _eI],
...
export var UpdateFormRequest$ = [3, n0, _UFR,
    0,
    [_aI, _eN, _i, _uF, _cTl],
...
export var UpdateThemeRequest$ = [3, n0, _UTR,
    0,
    [_aI, _eN, _i, _uT, _cTl],
...
export var ValueMappings$ = [3, n0, _VMa,
    0,
    [_v, _bP],
...
var Tags = 128 | 0;
export var ApiConfiguration$ = [4, n0, _AC,
    0,
    [_gQLC, _dSC, _nAC],
    [() => GraphQLRenderConfig$, () => DataStoreRenderConfig$, () => NoApiRenderConfig$]
];
export var CodegenJobRenderConfig$ = [4, n0, _CJRC,
    0,
    [_rea],
    [() => ReactStartCodegenJobData$]
];
export var FieldPosition$ = [4, n0, _FP,
    0,
    [_fix, _rOi, _be],
    [0, 0, 0]
];
export var FormStyleConfig$ = [4, n0, _FSC,
    0,
    [_tR, _val],
    [0, 0]
];
